...
public class ProyectoDAO {
    ...
    //Método que permite consultar un solo Proyecto con el ID
    ...
    //Método que permite consultar un sólo proyecto con el Nombre del Proyecto
    public ArrayList consultarUnSoloP(String sql) throws SQLException {
        con = cn.getConnection();
        ps = con.prepareStatement(sql);
        rs = ps.executeQuery();
        ArrayList listInqui = new ArrayList();
        while (rs.next()) {
            proyec.setIdCodigoProyecto(rs.getInt("idCodigoProyecto"));
            proyec.setNombre(rs.getString("nombre"));
            proyec.setTelefono(rs.getString("Telefono"));
            ...
            listInqui.add(new Proyecto(proyec.getIdCodigoProyecto(), proyec.getNombre(), proyec.getTelefono(),
                    proyec.getFecha(), proyec.getCiudad(), proyec.getResponsable()));
        }
        return listInqui;
    }
